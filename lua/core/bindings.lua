...
wk.add({
  ...
  { "<leader>L", require('scat.brazil').display_current_file_url, desc = "get gitfarm url" },
...
wk.add({
  { "<leader>L", require('scat.brazil').display_current_file_url, desc = "get gitfarm url", mode = "v" },
